...
Context Vault document limits are enforced at the workspace billing-owner level.
If an invited admin or member uploads a document, it still counts against the
workspace billing owner's document allowance.
