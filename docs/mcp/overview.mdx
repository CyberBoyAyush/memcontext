...
The server handles input validation, scope isolation, project name normalization, and formats responses for assistant consumption. All business logic — deduplication, classification, hybrid search — runs in the MemContext API.
