...
```bash
curl -X POST https://api.memcontext.in/api/context-vault/documents/upload \
...
```bash
curl -X POST https://api.memcontext.in/api/context-vault/documents \
...
```bash
curl "https://api.memcontext.in/api/context-vault/documents?workspaceId=8b3b8f4c-..." \
  -H "X-API-Key: mc_your_key"
```
...
```bash
curl "https://api.memcontext.in/api/context-vault/search?workspaceId=8b3b8f4c-...&query=leave%20policy&mode=hybrid" \
  -H "X-API-Key: mc_your_key"
```
